...
QByteArray& operator<<(QByteArray& bytes, const Book& book)
{
	...
	{
		QByteArray data;
		data.append(book.author.trimmed().toUtf8())
			.append('\04')
			.append(book.genre.trimmed().toUtf8())
			.append('\04')
			.append(book.title.trimmed().toUtf8())
			.append('\04')
			.append(seriesTitle.trimmed().toUtf8())
			.append('\04')
			.append(serNo.toUtf8())
			.append('\04')
			...
			.append(rateBytes)
			.append('\04')
			.append(book.keywords.trimmed().toUtf8())
			.append('\04')
			.append(book.year.trimmed().toUtf8())
			.append('\04')
